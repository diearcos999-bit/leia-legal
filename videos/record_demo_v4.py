"""
Demo video recorder v4 - Simplified selectors
...
async def record_demo():
    ...
    video_path = os.path.join(VIDEO_DIR, f"leia_demo_v4_{timestamp}.webm")

    print(f"🎬 Iniciando grabacion demo v4...")
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # Click send button (the one with "Enviar" text or Send icon)
